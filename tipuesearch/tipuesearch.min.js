...
{out+='<div id="tipue_search_results_count">'+ "1 ergebnis";}



else
{c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<div id="tipue_search_results_count">'+c_c+' '+"ergebnisse";}
if(set.showTime)
	


{var endTimer=new Date().getTime();var time=(endTimer-startTimer)/ 1000;set.showTime=false;}
